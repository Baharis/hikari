"""Finds two strongest peaks in spectrum

Usage:
  dacxrd_peaks.py [--method=METHOD] [--plot=PLOT] [--min_snr=MIN_SNR] [--min_n=MIN_N] [--type=TYPE] [--temperature-C=TEMP_C] [--temperature-unc=TEMP_UNC] SPECTRA_FILE
